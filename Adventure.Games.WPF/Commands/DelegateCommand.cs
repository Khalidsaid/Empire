...
namespace Adventure.Games.WPF.Commands
{
    ...
    public class DelegateCommand<T> : ICommand
    {
        ...
        public virtual async Task RaiseCanExecuteChanged()
        {
            if (CanExecuteChanged != null)
                await Application.Current.Dispatcher.InvokeAsync(() => CanExecuteChanged(this, EventArgs.Empty));
        }
    }
}
